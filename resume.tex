...
%\begin{center}
%\namesection {Alex}{Scott}
%\hdashrule[0ex]{6cm}{.8pt}{1pt}
 

%\mbox{

%{\color{RoyalBlue}\faGlobe} \, \color{black}\href{https://alexscott.io}{alexscott.io} \quad 
%
%
%{\color{RoyalBlue}\faLinkedin} \, \href{http://linkedin.com/in/alexscott64}{alexscott64} \quad 
%
%%\tikzcircle{2pt} \,
%
%{\color{RoyalBlue}\faGithub} \, \href{http://github.com/alexscott64}{alexscott64} \quad 
%
%
%{\color{RoyalBlue}\faEnvelopeO} \, \href{mailto:agscott1@uci.edu}{agscott1@uci.edu} \quad 
%
%%\tikzcircle{2pt} \, 
%
%{\color{RoyalBlue}\faPhone} \, 858.353.2243
%}
...
%\descript{\\PHP \tikz\draw[black,fill=blue] (0,0) circle (.5ex);\tikz\draw[black,fill=gray] (0,0) circle (.5ex);\tikz\draw[black,fill=gray] (0,0) circle (.5ex);\\Java \\Python \\JavaScript \\C++ \\C \\Matlab }
\descript{\\PHP \\Java \\Python \\JavaScript \\C++ \\C \\Matlab }
...
\descript{Node.js\\ React\\ SASS\\ Laravel }
